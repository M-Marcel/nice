...
const ContactForm = () => {
    ...
    return (
        <div className="bg-white w-[100%] md:w-[50%] lg:w-[30%] px-8 lg:px-4 py-6 h-auto mt-[120px] lg:mt-[40px] rounded-2xl">
            <form className="h-[auto] relative z-10 overflow-y-scroll hide-scrollbar">
