...
const ProductDropdown = ({ options, children }:DropdownProps) => {
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      {isOpen && (
        <div className="absolute bg-red-600 right-0 z-10 mt-2 w-48 origin-top-right rounded-md  shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1 ">
