...
const Certification = ({ portfolioData, updatePortfolioData, setActiveModal, setCertificationToEdit, isPublished }: CertificationProps) => {
    ...
    // Get initial certifications - only from localStorage, never from backend initially
    ...
    useEffect(() => {
        ...
        window.addEventListener('certificationUpdate', handleCertificationUpdate as EventListener);
        return () => {
            window.removeEventListener('certificationUpdate', handleCertificationUpdate as EventListener);
        };
    }, [editingIndex]);
                                        ...
                                        <div className="flex gap-2 items-center w-[60%]">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-400">
                                                    {certification.issuedBy} - {certification.yearIssued}
                                                </p>
                                            </div>
                                        </div>
