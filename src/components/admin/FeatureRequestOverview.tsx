...
type FeatureRequestOverviewProps = {
    TotalFeatures: number
}

const FeatureRequestOverview = ({TotalFeatures}: FeatureRequestOverviewProps) => {
    return (
        <div>
            <div className="flex flex-col border border-gray-600 py-4 px-4 rounded-lg">
                ...
                <div className="text-md mb-3 text-black-920 font-semibold">{TotalFeatures}</div>
