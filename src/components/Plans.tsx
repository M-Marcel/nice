...
const Plans = () => {
  return (
    <div className='relative top-[350px] custom-l-bg3 flex flex-col items-center justify-center'>
      <div className="flex flex-col max-w-3xl items-center text-center justify-center pt-20 ">
