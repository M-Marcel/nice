...
const Minimalist: React.FC<TestTemplateProps> = ({ templateId, templateData }) => {
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="social links flex justify-center gap-2 items-center">
                                <span className="bg-white px-4 py-4 rounded-full">
                                    <svg width="15" height="15" viewBox="0 0 44 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className="bg-white px-4 py-4 rounded-full">
                                    <svg width="15" height="15" viewBox="0 0 47 42" fill="none" xmlns="http://www.w3.org/2000/svg">
