...
const SignUp = () => {
    return(
        ...
        <form className="h-[55vh] overflow-y-scroll hide-scrollbar">
            ...
            <Button className="mt-3 custom-bg w-full text-white px-4 py-2 rounded-lg text-md font-semibold">Create Account</Button>
            <div className="flex justify-center items-center">
                <p className="text-gray-400 mt-2 text-sm">or sign up with</p>
            </div>
